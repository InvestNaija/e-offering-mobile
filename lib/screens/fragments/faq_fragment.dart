...
var faqs = [
  ...
  {'isExpanded' : false, 'question': 'Can I submit multiple applications in the same name?', 'answer': 'No. Multiple applications will be rejected. Only one application allowed per investor.'},
  {'isExpanded' : false, 'question': 'Will there be any charges when purchasing the shares on PrimaryOffer?', 'answer': 'No, there are no charges for purchasing shares, however investors will be required to pay payment processing fees'},
  {'isExpanded' : false, 'question': 'Can I change my password, how do I go about it?', 'answer': 'Kindly select the “forgot password” option on the landing page and follow the instructions for a password reset.'},
  ...
  {'isExpanded' : false, 'question': 'I have been debited but my payment status shows pending', 'answer': 'Kindly forward your proof of payment to <b>info@primaryoffer.com</b> for further review.'},
  ...
  {'isExpanded' : false, 'question': 'I am unable to relaunch the app after your recent update.', 'answer': 'Kindly update your device OS and try again'},
  ...
  {'isExpanded' : false, 'question': 'How do I contact your customer care?', 'answer': '<div class="text-danger"><b>Telephone</b> - (0700 46837862452)<br><b>Email</b> – info@primaryoffer.com</div>'},
];
